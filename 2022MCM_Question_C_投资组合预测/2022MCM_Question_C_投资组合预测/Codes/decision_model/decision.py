...
print("alpha_bit_sell", end='\t', file=fo)
print("alpha_bit_buy", end='\t', file=fo)
print("alpha_gold_sell", end='\t', file=fo)
print("alpha_gold_buy", end='\t', file=fo)
print("alpha_min_cash", end='\t', file=fo)
print("profit", file=fo)

for alpha_bit_sell in [10e-5, 1e-4, 1e-3, 1e-2, 1e-1, 0, 1e1, 1e2, 1e3, 1e4, 1e5]:
    for alpha_bit_buy in [10e-5, 1e-4, 1e-3, 1e-2, 1e-1, 0, 1e1, 1e2, 1e3, 1e4, 1e5]:
        for alpha_gold_sell in [10e-5, 1e-4, 1e-3, 1e-2, 1e-1, 0, 1e1, 1e2, 1e3, 1e4, 1e5]:
            for alpha_gold_buy in [10e-5, 1e-4, 1e-3, 1e-2, 1e-1, 0, 1e1, 1e2, 1e3, 1e4, 1e5]:
                for alpha_min_cash in [0, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.9, 0.95, 1]:
                    print(alpha_bit_sell, end='\t', file=fo)
                    print(alpha_bit_buy, end='\t', file=fo)
                    print(alpha_gold_sell, end='\t', file=fo)
                    print(alpha_gold_buy, end='\t', file=fo)
                    ...
                    for num in range(7, len(date_list)):
                        ...
                        if bit_prediction[num - 7] >= past_avg_bit_list[num - 7]:
                            ...
                            bit_sell_rate = ((bit_prediction[num - 7] - past_avg_bit_list[num - 7]) / past_avg_bit_list[num - 7]
                        ...
                        if bit_prediction[num - 7] < past_avg_bit_list[num - 7]:
                            # print("bit low")
                            bit_buy_rate = ((- bit_prediction[num - 7] + past_avg_bit_list[num - 7]) / past_avg_bit_list[num - 7]
